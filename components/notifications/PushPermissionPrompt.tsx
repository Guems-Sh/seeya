...
export default function PushPermissionPrompt() {
  ...
  return (
    <div className="fixed bottom-24 left-4 right-4 z-50 border-2 border-[#CCFF00] bg-black p-4 shadow-[4px_4px_0_0_#CCFF00] md:bottom-6 md:left-auto md:right-6 md:max-w-xs">
      ...
      <div className="flex gap-2">
        ...
        <button
          onClick={dismiss}
          className="border-2 border-[#333333] px-3 py-2.5 text-xs font-black uppercase tracking-widest text-[#555555] transition-colors hover:text-[#999999]"
        >
          PLUS TARD
        </button>
      </div>
